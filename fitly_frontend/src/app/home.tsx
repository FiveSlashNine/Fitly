...
import { faCopyright, faDumbbell, faInfo, faPersonRunning, faSearch, faShareNodes } from '@fortawesome/free-solid-svg-icons';
...
export default function Home() {
  ...
  const handleSearch = () => {
    ...
    if (sessionType) {
      ...
      router.push(`/AvailableSessions?location=${encodeURIComponent(location)}&type=${encodeURIComponent(sessionType)}`);
    } else {
      //ΑΝ ΧΡΗΣΤΗΣ ΔΕΝ ΕΠΙΛΕΞΕΙ ΤΥΠΟ ΓΥΜΝΑΣΤΙΚΗΣ ΣΤΕΛΝΕΙ ΜΟΝΟ ΤΟ LOCATION ΩΣΤΕ ΜΕΤΑ ΝΑ ΚΑΝΕΙ ΤΟ SEARCH ΜΟΝΟ ΓΙΑ ΤΟ LOCATION
      router.push(`/AvailableSessions?location=${encodeURIComponent(location)}`);
    }}
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* HEADER */}
      <header className="flex justify-between items-center px-8 py-5 shadow-sm bg-gradient-to-b from-emerald-50 to-white z-10">
      ...
      <main className="flex-grow pt-[120px] pb-16 px-8 bg-gradient-to-b from-white to-green-50">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-12">
          ...
          <div className="w-full md:w-1/2">
            <h2 className="text-3xl font-bold mb-2 text-emerald-800 text-center">Ανακάλυψε Το Ιδανικό Πρόγραμμα Γυμναστικής</h2>
            <p className="text-gray-600 mb-8 text-lg text-center">Αμέτρητα προγράμματα όπου και να βρίσκεσαι!</p>
              ...
              <div className="relative">
                  ...
                  {locationError && (
                    <p className="text-sm text-red-500 mt-2 ml-1">Παρακαλώ εισάγετε τοποθεσία.</p>
                  )}
                </div>
      ...
      <section className="py-12 px-8 bg-emerald-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="border border-emerald-200 rounded-lg p-6 mb-8 bg-white shadow-sm">
            <h3 className="text-lg font-medium text-emerald-700 mb-2">Υπηρεσίες μας</h3>
            <p className="text-gray-600">
            Ανακάλυψε τη λύση που ταιριάζει στις ανάγκες σου με λίγα μόνο κλικ! Είτε αναζητάς χώρο για να γυμναστείς 
            είτε προσφέρεις τα δικά σου προγράμματα ως επαγγελματίας ή επιχείρηση, εμείς έχουμε τη σωστή επιλογή για σένα. 
            Από προγράμματα για αρχάριους μέχρι προχωρημένους, έχουμε κάτι για όλους! Απλά διάλεξε την περιοχή και το πρόγραμμα που σου ταιριάζει και ξεκίνα την προπόνησή σου σήμερα!
            </p>
          </div>
          ...
          <div className="border border-emerald-100 rounded-lg p-6 bg-white shadow-sm hover:shadow-md hover:border-emerald-300 transition-all duration-300 transform hover:scale-[1.01] animate-fadeIn delay-100">
              <h3 className="text-lg font-medium mb-3 text-emerald-800">Αναζήτηση Προγραμμάτων Γυμναστικής Για Αθλούμενους</h3>
              <p className="text-gray-600 mb-6">
              Αγαπάς τη γυμναστική ή θέλεις να δοκιμάσεις νέα προγράμματα; Ή μήπως αναζητάς έναν νέο χώρο για την προπόνησή σου; Είμαστε εδώ για να σε βοηθήσουμε! Με μια απλή αναζήτηση, 
              βρες το πρόγραμμα ή το γυμναστήριο που σου ταιριάζει και κάνε την κράτησή σου εύκολα και γρήγορα!
              </p>
              <Link href="/signUpUser" className="px-4 py-2 border border-emerald-300 rounded-lg text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-colors font-medium">
                Εγγραφή
              </Link>
            </div>
            ...
            <div className="border border-emerald-100 rounded-lg p-6 bg-white shadow-sm hover:shadow-md hover:border-emerald-300 transition-all duration-300 transform hover:scale-[1.01] animate-fadeIn delay-200">
              <h3 className="text-lg font-medium mb-3 text-emerald-800">Παροχή Προγραμμάτων Γυμναστικής</h3>
              <p className="text-gray-600 mb-6">
              Είσαι ιδιοκτήτης γυμναστηρίου ή επαγγελματίας και θέλεις να προωθήσεις τον χώρο σου ή τα προγράμματα γυμναστικής σε ασκούμενους; 
              Αν ναι, το FITLY είναι εδώ για σένα! Στην πλατφόρμα μας, μπορείς να δημιουργήσεις
               και να προωθήσεις τα προγράμματά σου, ενώ εμείς αναλαμβάνουμε όλη τη δουλειά για σένα.
              </p>
              <Link href="/signUpGym" className="px-4 py-2 border border-emerald-300 rounded-lg text-emerald-700 bg-emerald-50 hover:bg-emerald-100 transition-colors font-medium">
                Εγγραφή
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-6">
                ...
                <a href="#" className="text-gray-600 hover:text-emerald-700 transition-colors text-xl"><FontAwesomeIcon icon={faLinkedin} className="w-8 h-8" /></a>

...
import {
  ...
  sessionStatuses,
  sessionTypes,
} from "@/app/[locale]/types/session";
import { useAuthStore } from "@/app/[locale]/lib/store";
import { bookSession, fetchSessions } from "@/app/[locale]/lib/sessionHandler";
...
function AvailableSessionsPage() {
  ...
  const t = useTranslations("AvailableSessionsPage");
            ...
            {sessions.map((session) => (
              <li key={session.id}>
                <SessionCard
                  session={session}
                  buttonLabel={
                    userId !== -1 ? t("button_book_session") : undefined
                  }
                  action={
                    userId !== -1
                      ? async () => {
